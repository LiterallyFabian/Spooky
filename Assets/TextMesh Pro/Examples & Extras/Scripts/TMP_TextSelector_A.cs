    ...
    public class TMP_TextSelector_A : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        void LateUpdate()
        {
            ...
            if (m_isHoveringObject)
            {
                ...
                {
                    //Debug.Log(System.DateTime.Now + "   " + "[" + m_TextMeshPro.textInfo.characterInfo[charIndex].character + "] has been selected.");
                ...
                if (wordIndex != -1 && wordIndex != m_lastWordIndex)
                {
                    ...
                    //Debug.Log(System.DateTime.Now + "   " + "Mouse Position: " + Input.mousePosition.ToString("f3") + "  Word Position: " + wordPOS.ToString("f3"));
