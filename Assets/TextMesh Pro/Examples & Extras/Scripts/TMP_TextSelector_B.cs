...
namespace TMPro.Examples
{
    ...
    public class TMP_TextSelector_B : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler, IPointerUpHandler
    {
        ...
        void LateUpdate()
        {
            if (isHoveringObject)
            {
                ...
                if (linkIndex != -1 && linkIndex != m_selectedLink)
                {
                    ...
                    // Debug.Log(System.DateTime.Now + "   " + "Link ID: \"" + linkInfo.GetLinkID() + "\"   Link Text: \"" + linkInfo.GetLinkText() + "\""); // Example of how to retrieve the Link ID and Link Text.
        ...
        {
            //Debug.Log(System.DateTime.Now + "   " + "Click at POS: " + eventData.position + "  World POS: " + eventData.worldPosition);
            ...
            if (charIndex != -1 && charIndex != m_lastIndex)
            {
                //Debug.Log(System.DateTime.Now + "   " + "Character [" + m_TextMeshPro.textInfo.characterInfo[index].character + "] was selected at POS: " + eventData.position);
                m_lastIndex = charIndex;
            ...
            */
            ...
            if (linkIndex != -1)
            {
                ...
                //Debug.Log(System.DateTime.Now + "   " + TMP_TextUtilities.GetSimpleHashCode("id_02"));
        ...
        {
            //Debug.Log(System.DateTime.Now + "   " + "OnPointerUp()");
        }
