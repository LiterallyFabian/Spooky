...
namespace TMPro.Examples
{
    ...
    public class TextMeshProFloatingText : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            {
                //Debug.Log(System.DateTime.Now + "   " + "Spawning TextMesh Objects.");
        ...
        public IEnumerator DisplayTextMeshProFloatingText()
        {
            ...
            while (current_Count > 0)
            {
                ...
                if (current_Count <= 3)
                {
                    //Debug.Log(System.DateTime.Now + "   " + "Fading Counter ... " + current_Count.ToString("f2"));
            ...
            //Debug.Log(System.DateTime.Now + "   " + "Done Counting down.");
        ...
        public IEnumerator DisplayTextMeshFloatingText()
        {
            ...
            while (current_Count > 0)
            {
                ...
                //Debug.Log(System.DateTime.Now + "   " + "Current Count:" + current_Count.ToString("f2"));
