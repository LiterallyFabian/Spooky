            ...
            for (int i = 0; i < m_TextInfo.wordCount; i++)
            {
                ...
                for (int j = 0; j < wInfo.characterCount; j++)
                {
                    ...
                    if (isBeginRegion == false && isCharacterVisible)
                    {
                        ...
                        //Debug.Log(System.DateTime.Now + "   " + "Start Word Region at [" + currentCharInfo.character + "]");
                        ...
                        if (wInfo.characterCount == 1)
                        {
                            ...
                            //Debug.Log(System.DateTime.Now + "   " + "End Word Region at [" + currentCharInfo.character + "]");
                        }
                    }
                ...
                //Debug.Log(System.DateTime.Now + "   " + wInfo.GetWord(m_TextMeshPro.textInfo.characterInfo));
            }
